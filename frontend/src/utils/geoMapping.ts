...
const isoCodeMap: Record<string, string> = {
  ...
  "LU": "Luxembourg", "MY": "Malaysia", "MX": "Mexico", "MD": "Moldova",
  "ME": "Montenegro", "MA": "Morocco", "NP": "Nepal", "NL": "Netherlands",
  "NZ": "New Zealand", "NI": "Nicaragua", "NG": "Nigeria", "MK": "North Macedonia",
  "NO": "Norway", "PK": "Pakistan", "PA": "Panama", "PY": "Paraguay",
  "PE": "Peru", "PH": "Philippines", "PL": "Poland", "PT": "Portugal",
  "PR": "Puerto Rico", "RO": "Romania", "RU": "Russia", "SA": "Saudi Arabia",
...
export function getCountryCoordinates(country: string): { lat: number; lng: number } | null {
  ...
  const direct = countryCoordinates[country];
  ...
  const isoName = isoCodeMap[upper];
  if (isoName && countryCoordinates[isoName]) return countryCoordinates[isoName];
