...
export function FullscreenOverlay({
  ...
  return (
    ...
    >
      ...
      {/* Gradient overlay for legibility — red-tinted for eye protection */}
      <div
        className="absolute inset-0 z-10 pointer-events-none"
        style={{
          background:
            "linear-gradient(to top, rgba(28,6,2,0.88) 0%, rgba(28,6,2,0.35) 50%, rgba(28,6,2,0.22) 100%)",
        }}
      />

      {/* Fallback background when no station — red-tinted dark */}
      {!station && (
        <div
          className="absolute inset-0"
          style={{ backgroundColor: "oklch(0.10 0.030 18)" }}
        />
      )}
