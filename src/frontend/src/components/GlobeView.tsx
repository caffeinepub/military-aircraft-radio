...
function EarthScene({
  ...
  useEffect(() => {
    if (isLight) {
      ...
      // Deep amber-dark matching dark mode ember palette (--background ~oklch 0.11 0.025 35)
      scene.background = new THREE.Color(0x0f0b07);
      gl.setClearColor(0x0f0b07, 1);
    }
  }, [isLight, scene, gl]);
  ...
  useEffect(() => {
    ...
    for (const sp of stationPoints) {
      const isCurrent =
        currentStation && sp.station.name === currentStation.name;
          ...
          <div
            ...
            style={{
              backgroundColor: isLight
                ...
                : "rgba(18,13,8,0.94)",
              color: isLight ? "#1a1208" : "#e8c87a",
              border: isLight
                ? "1px solid rgba(0,0,0,0.12)"
                : "1px solid rgba(200,140,60,0.20)",
